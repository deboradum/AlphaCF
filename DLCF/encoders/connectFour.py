    ...
    def encode(self, game_states: List[GameStateTemplate]):
        ...
        for i, game_state in enumerate(game_states):
            ...
            if game_state.next_player == Player.black:
                board_tensors[i, FEATRE_OFFSETS['black_to_move']] = 1
            else:
                board_tensors[i, FEATRE_OFFSETS['white_to_move']] = 1
        ...
        # Assign pieces
        board_tensors[b_idx_black, FEATRE_OFFSETS['black_pieces'], r_idx_black, c_idx_black] = 1
        board_tensors[b_idx_white, FEATRE_OFFSETS['white_pieces'], r_idx_white, c_idx_white] = 1

        # Assign winning moves
        board_tensors[b_idx_win_black, FEATRE_OFFSETS['black_winning_moves'], r_idx_win_black, c_idx_win_black] = 1
        board_tensors[b_idx_win_white, FEATRE_OFFSETS['white_winning_moves'], r_idx_win_white, c_idx_win_white] = 1
